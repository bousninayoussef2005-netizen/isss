...
| [pi/MONITORING.md](./pi/MONITORING.md) | Pi: **`journalctl`** / health checks for edge services |
| [pi/FIRESTORE-LAB.md](./pi/FIRESTORE-LAB.md) | Pi service account IAM + Firestore rules notes |
...
- **Phase 2 — bridge:** **Done** — **`serial_bridge.py`** + **systemd** bridge. **Phase 3 — kiosk:** **[PHASE3.md](./PHASE3.md)** — borrow/return worker, USB-serial barcode script, **systemd** units + **`pi/MONITORING.md`** + **`pi/FIRESTORE-LAB.md`**.
