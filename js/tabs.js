...
const renderers = {
  ...
  "u-catalog": () => `<div class="card" style="margin-bottom:14px"><div class="card-body catalog-user-status" id="catalog-user-status" style="padding:14px 18px"></div></div><input type="text" class="search-bar" id="catalog-search" placeholder="Search books by title, ID, barcode, author, or category..." oninput="renderCatalog()" onkeydown="window.onCatalogSearchKeydown && window.onCatalogSearchKeydown(event)"><div class="book-grid" id="catalog-grid"></div>`
};
